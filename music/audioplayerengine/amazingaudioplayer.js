        ...
        var PlayerSkin = function(amazingPlayer, container, options, id) {
            ...
            if (this.options.showimage) {
                ...
                this.container.on("amazingaudioplayer.updateinfo", function(event, data) {
                    if (data.image.length > 0) instance.$image.html("<div class='amazingaudioplayer-image-space' style='display:inline-block;vertical-align:middle;height:100%;'></div><img src='" +
                        data.image + "' style='width:100%;max-width:100%;vertical-align:middle;' />");
            ...
            if (!isTouch ||
                !this.options.disablehoverontouch) $play.hover(function() {
                $(this).css({
            ...
            this.container.on("amazingaudioplayer.paused", function(event, currentItem) {
                ...
                if (instance.options.enablega && instance.options.gatrackingid && window.ga) ga("send",
                    "event", instance.options.gacategory, "pause", instance.amazingPlayer.elemArray[currentItem].title, instance.options.gaeventvalue)
            });
            ...
            this.container.on("amazingaudioplayer.ended",
                function(event, currentItem) {
                    ...
                    switch (this.options.volumebarposition) {
                        ...
                        case "right":
                            this.$volumeBar.css({
                                ...
                                top: 0,
                                height: this.options.volumebarwidth - 2 * this.options.volumebarpadding,
                                width: this.options.volumebarheight -
            ...
            if (this.options.showtime) {
                ...
                $time.appendTo($bar);
                this.container.on("amazingaudioplayer.playprogress",
                    function(event, data) {
            ...
            if (this.options.addwm && window.location.href.indexOf(this.options.fvm) < 0) {
                var $wm = $("<div style='position:absolute;top:100%;right:0;margin:4px;text-align:right;font:normal 10px Arial, sans-serif;'></div>");
                $wm.appendTo(this.container)
            }
        };
        var FlashHTML5Player =
            function(amazingPlayer, flashPlayerEngine) {
                this.amazingPlayer = amazingPlayer;
            ...
            load: function(audioItem) {
                ...
                if (!AmazingAudioPlatforms.isIE6789())
                    for (i = 0; i < audioSource.length; i++)
                        if (audioSource[i].type == "audio/mpeg" && this.supportMp3 || audioSource[i].type ==
                            "audio/ogg" && this.supportOgg) {
                            this.isHtml5 = true;
                            break
                        }
        ...
        AmazingAudioPlayer.prototype = {
            ...
            init: function(instance) {
                ...
                if ("autoplayaudio" in params)
                    if (params["autoplayaudio"] == "1") instance.options.autoplay =
                        true;
                ...
                else if (instance.currentItem >= 0 && startTime > 0 && startTime < instance.elemArray[instance.currentItem].duration) instance.setTime(startTime /
                    instance.elemArray[instance.currentItem].duration);
            ...
            drawShoutcast: function(data) {
                ...
                if (instance.options.showliveplayedlist) {
                    ...
                    var count = Math.min(instance.options.maxplayedlist,
                        data.length);
                    ...
                    for (var i = 0; i < count; i++) {
                        ...
                        text += data[i].title ? '<div class="amazingaudioplayer-playedlist-item-shoutcast-title">' +
                            data[i].title + "</div>" : "";
            ...
            updateLiveShoutcastByHTML: function() {
                if (typeof wonderplugin_audio_ajaxobject == "undefined" && !instance.options.shoutcastservice) return;
                var instance = this;
                clearTimeout(instance.liveUpdateTimeout);
            ...
            checkMK: function() {
                if (this.options.vm == "AMF" + "ree") {
                    ...
                    if (mklink.length < 0 || mklink.text().indexOf(this.options.pvm) < 0 || mklink.attr("href") !== this.options.lvm) {
    ...
    $.amascrollbar = function(parent, child, options) {
        ...
        scrollthumb.on("mousedown", function(e) {
            ...
            $(document).on("mousemove.amadraggable", function(e) {
                ...
                if (t > scrollbar.offset().top + visibleheight - thumbheight) t = scrollbar.offset().top + visibleheight -
                    thumbheight;
                dragged.offset({
                    top: t
                });
